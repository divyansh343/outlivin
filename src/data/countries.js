export const countrys = [
    {
        ...
        desc: "Germany has the largest economy in Europe and the fifth-largest in the world, so there are plenty of jobs in Germany for foreigners with specialist skills.",

        about: [
            "Germany is one of the top European countries in terms of the number of people who look for a well-paid and rewarding job.",

            "The average working hours in Germany are between 36 and 40 hours per week. They are regulated strictly by the law, meaning you're daily working hours must not exceed eight hours and the weekly working time is restricted to 48 hours."
        ],
        jobDemandIndustries: [
            "engineering",
            "mechanical",
        ...
        keyJobs: [
            "Software developers", "architects", "programmers", "Economists", "business management experts", "Sales representatives", "assistants",
        ...
        favPolicies: [
            ...
            "To qualify for the EU Blue Card, you will need to have already found a job in Germany, and the minimum annual salary must be 56,800 Euros. The EU Blue Card grants its holders the right to stay in Germany for four years, with a possibility of changing their residence permit into a permanent settlement."
    ...
    },
    {
        ...
        desc: "English is widely spoken and those that live on the Emerald Isle are friendly and welcoming. The country has one of the highest standards of living in Europe.",
        about: [
    ...
    },
    {
        ...
        officialCurrency: "United States Dollar",
        languages: [
            "English",
        ],

        desc: "The United States is home to nearly 45 million immigrants – more than any other country in the world.",
        ...
        favPolicies: [
            "United States grant up to 675,000 permanent immigrant visas each year across various visa categories. On top of those 675,000 visas, the INA sets no limit on the annual admission of U.S. citizens' spouses, parents, and children under the age of 21.",
    ...
    },
    {
        ...
        officialCurrency: { currency: "Canadian dollar", symbol: "CAD" },
        languages: [
            "English",
            "French"
        ],
